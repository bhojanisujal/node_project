    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-6 py-2 rounded-lg hover:from-cyan-600 hover:to-teal-600 transition-all duration-200"
        >
          Add New User
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="shadow-md border border-transparent backdrop-blur-3xl rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105">
      ...
      {/* Filters */}
      <div className="shadow-md border border-transparent backdrop-blur-3xl rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300">
      ...
      {/* Users Table */}
      <div className="shadow-md border border-transparent backdrop-blur-3xl rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300 overflow-hidden">
      ...
      {isModalVisible && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="shadow-md border border-transparent backdrop-blur-3xl rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-700 text-white px-4 py-2 rounded-lg border border-slate-600 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all duration-200"
                />
                {errors.name && (
