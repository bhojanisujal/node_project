...
const features = [
  {
    icon: (
      <svg
        className="w-12 h-12 t4s-icon-car fill-current text-green-700"
        viewBox="0 0 29 32"
        width="29"
        height="32"
      >
    ...
    title: "Free Shipping",
    description: "Free shipping on all order or order above ₹500",
  },
  {
    icon: (
      <svg
        className="w-12 h-12 t4s-icon-help fill-current text-green-700"
        viewBox="0 0 32 32"
        width="32"
        height="32"
      >
  ...
  },
  {
    icon: (
      <svg
        className="w-12 h-12 t4s-icon-refesh fill-current text-green-700"
        viewBox="0 0 32 32"
        width="32"
        height="32"
      >
  ...
  },
  {
    icon: (
      <svg
        className="w-12 h-12 t4s-icon-door-lock fill-current text-green-700"
        viewBox="0 0 27 32"
        width="27"
        height="32"
      >
